...
namespace APIFeaturedImage\WPAdminPage;

use APIFeaturedImage\WPAdminPage\FormHelper as Form;
...
abstract class AdminPage
{
     ...
     * class version.
     */
    public const ADMINVERSION = '2.1.0';
    ...
    public function __construct(
        ...
        $default['function'] 	  = [ $this, 'menu_callback' ];
        ...
        $this->function     = [ $this, 'menu_callback' ];
    ...
    public function wp_actions()
    {
        ...
        // styles_admin
        add_action( 'admin_enqueue_scripts',[ $this, 'admin_page_styles'] );

        // footer_separator
        add_action( 'swa_footer',[ $this, 'footer_separator' ] );
    }
     ...
     * Simple CSS Styles
     */
    public function admin_page_styles(): void
    {
        wp_enqueue_style( 'wll-admin-style', plugin_dir_url( __FILE__ ) . 'assets/wll-admin.css', [], self::ADMINVERSION, 'all' );
    }
     ...
     */
    public function footer_separator(): void
    {
        echo '<hr/>';
    }
    ...
    {
        return $this->admin_path() . $this->menu_slug() . '/' . $this->page_name() . '.admin.php';
    }
     ...
     * @since 2.0
     */
    public function adminonly_callback(): void
    {
